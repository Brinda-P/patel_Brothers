...
Container cartitem(){
  ...
  List<CartItemDetail> ItemDetailList = [
    CartItemDetail(ItemName: 'Fastdry Active Training Jacket', Price: '₹ 779.00', MRP: '₹ 999.00', SavePrice: '₹ 280.00', Size: 'S', Color: 'Light Blue', SoldBy: 'N M AGGARWAL AND COMPANY Pnt. Ltd.', Image: MENJACKET, PageName: '/apparelpage' ),
    CartItemDetail(ItemName: 'The Fab Factory Women Light Blue Solid Crepe Georgette Pack of 2 Kurta Set', Price: '₹ 779.00', MRP: '₹ 2749.00', SavePrice: '₹ 1970.00', Size: 'S', Color: 'Light Blue', SoldBy: '', Image: WOMENKURTA, PageName: '/offeritem'),
    CartItemDetail(ItemName: 'Dove Nutritive Solutions Intense Repair Shampoo 650 ml', Price: '₹ 649.00', MRP: '₹ 999.00', SavePrice: '₹ 280.00', Size: '',Color: '' , SoldBy: "Patel Brother's", Image: DOVESHAMPOO, PageName: '/offeritem'),
  ];
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('Size : ${ItemDetailList[index].Size} / Colour : ${ItemDetailList[index].Color}', style: TextStyle(fontSize: 10),),

                            Text('Sold by ${ItemDetailList[index].SoldBy}', style: TextStyle(fontSize: 10)),
                            SizedBox(height: 5),
                            Row(
...
class CartItemDetail{
  ...
  CartItemDetail({required this.ItemName, required this.Price, required this.MRP, required this.SavePrice, required this.Size, required this.Color, required this.SoldBy, required this.Image,required this.PageName});
}